  ...
  return (
    ...
    <div className='service'>
        <div className="single-service">
            <img src={process.env.PUBLIC_URL + "/image/burger1.png"} alt="" height="150" width="auto"/>
            <p className='title-single-service'>Choose your food</p>
            <p className='desc-single-service'>Easy to order what you want</p>
        </div>
        <div className="single-service">
            <img src={process.env.PUBLIC_URL + "/image/scooter.png"} alt="" height="150" width="auto"/>
            <p className='title-single-service'>Fast delivery</p>
            <p className='desc-single-service'>Get your food fastest</p>
        </div>
        <div className="single-service">
            <img src={process.env.PUBLIC_URL + "/image/good.png"} alt="" height="150" width="auto"/>
